...
- With composition, objects can dynamically change behavior at runtime
...
Every responsibility of a class is an area of potential change. More than one responsibility means more than one area of change. A class should have only one reason to change.
