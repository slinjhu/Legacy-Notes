...
- OO Principles ::
    ...
    - Favor composition over inheritance. With composition, objects can be changed dynamically at runtime; with inheritance, objects are fixed after compilation.
